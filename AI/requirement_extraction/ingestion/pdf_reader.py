...
from ..schema.models import PageText

logger = logging.getLogger("insuremate.requirement_extraction.ingestion")
...
class PDFReader:
    ...
    def extract_from_bytes(pdf_bytes: bytes) -> List[PageText]:
        """Extract text from raw PDF bytes using pypdfium2 with pymupdf fallback."""
